                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="background-color: #ffffff; border-collapse: collapse;">
                    ...
                    <tr>
                        <td align="center" style="background-color: #e60000; padding: 20px; color: #ffffff;">
                            <h1 style="margin: 0; font-size: 24px;">Airtime & Interbank ESB Service Project</h1>
                        </td>
                    </tr>
                    <!-- Content -->
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="margin: 0 0 10px; line-height: 1.6;">
                                Your request with ID: <strong>${document_id}</strong> for Module ${module_name} has been <span style="font-weight: bold; color: ${approval_status === 'Approved' ? '#28a745' : '#dc3545'};">${approval_status}</span>.
                            </p>

                            <p style="margin: 0 0 10px; line-height: 1.6;">Approval Message: <strong>${approval_message}</strong></p>

                            <p style="margin: 0 0 10px; line-height: 1.6;">You can view the report of your document by logging into your account or clicking the button below:</p>
