          ...
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="background-color: #ffffff; border-collapse: collapse;">
            ...
            <tr>
              <td style="padding: 20px;">
                ...
                <p style="margin: 0 0 10px; line-height: 1.6;">A file upload has been uploaded for <strong>${module_name}</strong> with request_id: <strong>${document_id}</strong></p>
                <p style="margin: 0 0 10px; line-height: 1.6;">Total transactions: <strong>${total}</strong></p>
                <p style="margin: 0 0 10px; line-height: 1.6;">Successfully validated: <strong>${succ}</strong></p>
                <p style="margin: 0 0 10px; line-height: 1.6;">Failed: <strong>${fail}</strong></p>
                <p style="margin: 0 0 10px; line-height: 1.6;">You can view the details of your document by logging into your account or clicking the button below:</p>
                <!-- Button -->
                <p style="text-align: center; margin: 20px 0;">
                  <a href="https://10.100.22.238/login/"
                    style="background-color: #e60000; color: white; padding: 12px 20px; border-radius: 5px; font-size: 16px; text-decoration: none; display: inline-block;">
                    Click here
                  </a>
                </p>
