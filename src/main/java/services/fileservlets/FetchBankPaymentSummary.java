...
public class FetchBankPaymentSummary extends FileServlet {
    ...
    protected void doGet(HttpServletRequest servletRequest, HttpServletResponse servletResponse) throws IOException {
        ...
        if (!module.equalsIgnoreCase(String.valueOf(ModuleName.INTER_BANK_BULK_PAYMENT_SUMMARY)) &&
                !module.equalsIgnoreCase(String.valueOf(ModuleName.INTRA_BANK_BULK_PAYMENT_SUMMARY))) {
            JsonObject errorResponse = Json.createObjectBuilder()
                    .add("status", "99")
        ...
        JsonObject result = transactionService.getPaymentSummariesByDateRange(module, startDate, endDate, batchId, size, page);
