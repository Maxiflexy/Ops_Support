...
import static constants.AppConstants.DbTables.EXCEPTIONAL_REVERSAL;
import static constants.AppConstants.DbTables.FUNDS_RECOUP;

public class ExceptionalReversalDbHelper implements FileUploadOps{

    final static Logger LOG = LogManager.getLogger(ExceptionalReversalDbHelper.class);
