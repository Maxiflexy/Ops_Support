...
import static constants.AppConstants.DbTables.UNSETTLED_TRANSACTION;

public class UnsettledTransactionDbHelper implements FileUploadOps {

    final static Logger LOG = LogManager.getLogger(UnsettledTransactionDbHelper.class);
    ...
    public boolean fetchDocumentDetails(BaseBean requestBean, JsonObject request) {
        ...
        String query = "SELECT * FROM "
                .concat(AppConstants.DbTables.UNSETTLED_TRANSACTION)
                .concat(" f LEFT JOIN ")
        ...
        if (requestBean.containsKey("paginated") && requestBean.getString("paginated").equals("true")) {
